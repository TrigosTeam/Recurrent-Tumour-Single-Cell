...
CA0046_ruvsrt <- readRDS("~/Fig2_signature/sc_integration/perpatient/tumor_only/CA0046_ruvsrt.Rds")
CA0090_ruvsrt <- readRDS("~/Fig2_signature/sc_integration/perpatient/tumor_only/CA0090_ruvsrt.Rds")
CA0058_ruvsrt <- readRDS("~/Fig2_signature/sc_integration/perpatient/tumor_only/CA0058_ruvsrt.Rds")
CA0027_ruvsrt <- readRDS("~/Fig2_signature/sc_integration/perpatient/tumor_only/CA0027_ruvsrt.Rds")
...
library(scran)
library(ggplot2)
CA90_13 <- readRDS("~/240731_seurat_flex/CA0090/p13/CA0090_p13_srt_new_filtering_doublets_non_tumour_removed.Rds")
...
saveRDS(srt3, "~/240731_seurat_flex/CA0090/p13/CA0090_p13_srt_new_filtering_doublets_non_tumour_removed_v4.Rds")
srt3 <- readRDS("~/240731_seurat_flex/CA0090/p13/CA0090_p13_srt_new_filtering_doublets_non_tumour_removed_v4.Rds")
normal <- readRDS("~/normal_cell_annotation/subtype/final_normalsrt.Rds")
...
CA90_18 <- readRDS("~/240731_seurat_flex/CA0090/p18/CA0090_p18_srt_new_filtering_doublets_non_tumour_removed.Rds")
...
saveRDS(srt3, "~/240731_seurat_flex/CA0090/p18/CA0090_p18_srt_new_filtering_doublets_non_tumour_removed_v4.Rds")
normal <- readRDS("~/normal_cell_annotation/subtype/final_normalsrt.Rds")
normal[["RNA"]] <- normal[["RNA2"]]
tumor_normal <- merge(srt3, normal)
counts <- tumor_normal[["RNA"]]@counts
