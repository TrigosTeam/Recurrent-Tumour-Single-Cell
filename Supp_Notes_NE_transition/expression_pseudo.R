...
setwd("~/Supp_Notes_NE_transition")
...
line.data <- readRDS("~/Supp_Notes_NE_transition/line.data.Rds")
TSCAN.pseudo <- readRDS("~/Supp_Notes_NE_transition/TSCAN.pseudo.Rds")
...
ggsave("~/Supp_Notes_NE_transition/NE12pseudo.pdf", width = 5, height = 5, unit = "cm")
