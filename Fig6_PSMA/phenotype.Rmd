...
tumor_normal_meta <- readRDS("~/Fig6_PSMA/tumor_normal_meta.Rds")
...
```{r}
meta = phenotype_meta <- readRDS("~/Fig6_PSMA/phenotype_meta.Rds")
...
```{r}
ARhighDEG <- readRDS("~/Fig6_PSMA/ARhighDEG.Rds")
ARlowDEG <- readRDS("~/Fig6_PSMA/ARlowDEG.Rds")
ARnegDEG <- readRDS("~/Fig6_PSMA/ARnegDEG.Rds")
```
...
srt<- readRDS(paths[i])
  ...
  subclone <- readRDS(paste("~/240628_ATAClone", patient, sample, "leiden_cluster.Rds", sep = "/"))
