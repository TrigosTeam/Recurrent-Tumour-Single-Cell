...
meta <- readRDS("~/integration/tumor_only_meta_expression.Rds")
sites <- meta$sample
...
melt(meta, )
#phenotype generation is in ~/integration/AR_PSMA_NE_phenotype.R
meta <- readRDS("~/integration/tumor_only_phenotype_meta.Rds")
sites <- meta$sample
sites[grep("brain", sites)] <- "brain"
sites[grep("dura", sites)] <- "dura"
sites[grep("prostate", sites)] <- "prostate"
