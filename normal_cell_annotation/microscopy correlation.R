...
library(Seurat)
library(patchwork)
microscopy <- read_excel("~/normal_cell_annotation/Microscopy_annotation_RY Feb2024.xlsx", sheet = 3)
...
signature_meta_tumor_normal <- readRDS("~/Fig2_signature/signature_meta_tumor_normal.Rds")
...
pdf("~/normal_cell_annotation/microscopy_cor_cellprop.pdf", width =9, height = 4)
