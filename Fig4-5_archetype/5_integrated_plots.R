...
saveRDS(srt@meta.data, "~/Fig4-5_archetype/5_integrated_final_module_meta.Rds")
source("~/CASCADEpaper/paper/functions.R")

pdf("~/Fig4-5_archetype/5_integrated_plot.pdf", width = 8, height = 4)
...
saveRDS(markerlist, "~/Fig4-5_archetype/5_integrated_markerlist.Rds")
