...
saveRDS(test, "~/Fig2_signature/sc_integration/tumor_normal_RNA_simspec_srt.Rds")
...
pdf( "~/Fig2_signature/sc_integration/tumor_normal_RNA_simspec_UMAP.pdf", width = 20, height = 10)
