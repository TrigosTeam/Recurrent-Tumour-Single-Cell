...
lapply(split(paths, patients), function(pathp){
  ...
  saveRDS(test, paste0("~/Fig2_signature/sc_integration/perpatient/tumor_only/",patient, "_tumor_only_RNA_simspec_srt.Rds"))
  ...
  pdf( paste0("~/Fig2_signature/sc_integration/perpatient/tumor_only/",patient, "_tumor_only_RNA_simspec_UMAP.pdf"), width = 10, height = 5)
