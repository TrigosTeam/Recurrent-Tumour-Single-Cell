...
purplereport <- readRDS("~/Fig3_genomics_normal_cells/purplereport.Rds")
...
comp <- readRDS("~/Fig2_signature/sc_integration/DEG/inter_interlesion_comp.Rds")
...
tumor_only_logPAC <- readRDS("~/Fig2_signature/sc_integration/tumor_only_logPAC.Rds")
