...
geneCNA <- readRDS("~/Desktop/plot_local/oncoplots/geneCNAlist.Rds")
# geneCNA <- geneCNA[-9]
...
sv <- readRDS("~/Desktop/plot_local/oncoplots/sv_list.Rds")
SO_table <- readRDS("~/Desktop/plot_local/oncoplots/point_mutation_table_intersect.Rds")
```
...
wgd <- readRDS("~/Desktop/plot_local/oncoplots/wgd.Rds")
```
