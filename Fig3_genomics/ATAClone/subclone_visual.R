...
for (p in  sub_path){
  ...
  # saveRDS(f, paste0("~/CASCADEpaper/paper/Fig3/ATAClone/plot_obj/", i, "_srt.Rds"))
...
# saveRDS(ht, paste0("~/CASCADEpaper/paper/Fig3/ATAClone/plot_obj/", i, "_heatmap.Rds"))
...
for (p in unique(substr(names(subclones), 1, 6))[c(1,6)]){
  ...
  srt <- readRDS(paste0("~/integration/2024_06/perpatient/tumor_only/", p, "_ruvsrt.Rds"))
