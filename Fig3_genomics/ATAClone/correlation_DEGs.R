...
sub_path <- system("realpath /trigos_team/CASCADE/Analysis/240628_ATAClone/*/*/leiden_cluster.Rds", intern = T)
...
for (p in  sub_path){
  ...
  if (length(unique(as.character(subclone)))>1){
    ...
    single_cn <- readRDS(paste("/trigos_team/CASCADE/Analysis/240628_ATAClone", patient, sample, "single_cn.Rds", sep = "/"))
...
saveRDS(DEGs, "~/CASCADEpaper/paper/Fig3_genomics/ATAClone/DEGs.Rds")
saveRDS(DE_region, "~/CASCADEpaper/paper/Fig3_genomics/ATAClone/DE_region.Rds")
...
saveRDS(temp, "~/CASCADEpaper/paper/Fig3_genomics/ATAClone/prop_vs_nregion.Rds")
...
saveRDS(endf, "~/CASCADEpaper/paper/Fig3_genomics/ATAClone/endf.Rds")
#### DEGs proportion
# DEGs <- readRDS("~/CASCADEpaper/paper/Fig3_genomics/ATAClone/DEGs.Rds")
# 
# for (p in  sub_path){
