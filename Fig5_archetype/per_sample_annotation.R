...
paths <- list.files("~/CASCADEpaper/paper/Fig5_archetype/4_srt_meta", full.names = T)
...
names(annos) <- gsub(".Rds", "", list.files("~/CASCADEpaper/paper/Fig5_archetype/4_srt_meta"))

saveRDS(annos,"~/CASCADEpaper/paper/Fig5_archetype/per_sample_anno.Rds" )
