...
for (i in paths_split){
  ...
  saveRDS(arc_1, paste0("~/regulon/new_regulon/archetype/2024_06/2_arc/", i, ".Rds"))
  
  
  activ = readRDS(paste0("~/regulon/new_regulon/archetype/2024_06/1_modulescore_msigdb/", i, ".Rds"))
  ...
  saveRDS(data_attr, paste0("~/regulon/new_regulon/archetype/2024_06/2_data_attr/", i, ".Rds"))
  ...
  saveRDS(list(gene = enriched_genes, set = enriched_sets, lab = labs), paste0("~/regulon/new_regulon/archetype/2024_06/2_enrichment/", i, ".Rds"))
  ...
  Idents(srt) <- srt$arc
  pdf(paste0("~/regulon/new_regulon/archetype/2024_06/2_srt_plots/", i, ".pdf"), height = 4, width = 4)
  ...
  saveRDS(markers, paste0("~/regulon/new_regulon/archetype/2024_06/2_marker/", i, ".Rds"))
  saveRDS(srt@meta.data,paste0("~/regulon/new_regulon/archetype/2024_06/2_meta/", i, ".Rds") )
