...
for (i in paths_split){
  ...
  arc_ks = k_fit_pch(PCs4arch, ks = 2:8, check_installed = T,
                     ...
                     sample_prop = 0.65)
  pdf(paste0("~/regulon/new_regulon/archetype/2024_06/1_noc_plots/", i, ".pdf"), width = 8, height = 6)
  ...
  dev.off()
  saveRDS(arc_ks,paste0("~/regulon/new_regulon/archetype/2024_06/1_arc_ks/", i, ".Rds"))
  ...
  saveRDS(modules, paste0("~/regulon/new_regulon/archetype/2024_06/1_modulescore_msigdb/", i, ".Rds"))
