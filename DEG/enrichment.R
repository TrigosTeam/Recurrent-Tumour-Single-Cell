...
# saveRDS(enlists, "~/integration/2024_06/DEG/enlist_interpatient.Rds")
...
geneCNAlist <- readRDS("~/CASCADEpaper/paper/Fig3/copy_number/geneCNAlist.Rds")
...
enlists <- lapply(genelists, function(x) try(GSEA(geneList = x, TERM2GENE = all)))
saveRDS(enlists, "~/integration/2024_06/DEG/enlist_interpatient_cna_aff.Rds")
genelists <- lapply(cna_free, generate_genelist)
enlists <- lapply(genelists, function(x) try(GSEA(geneList = x, TERM2GENE = all)))
saveRDS(enlists, "~/integration/2024_06/DEG/enlist_interpatient_cna_free.Rds")

# for(i in list.files("~/integration/2024_06/DEG/inter_lesion")){
#   degs <- readRDS(paste0("~/integration/2024_06/DEG/inter_lesion/", i))
#   genelists <- lapply(degs, generate_genelist)
#   enlists <- lapply(genelists, function(x) try(GSEA(geneList = x, TERM2GENE = all)))
#   saveRDS(enlists, paste0("~/integration/2024_06/DEG/inter_lesion/enrich_", i))
#   print(i)
# }

for(i in list.files("~/integration/2024_06/DEG/inter_lesion", pattern ="^CA")){
  DEGs <- readRDS(paste0("~/integration/2024_06/DEG/inter_lesion/", i))
  ...
  genelists <- lapply(cna_aff, generate_genelist)
  enlists <- lapply(genelists, function(x) try(GSEA(geneList = x, TERM2GENE = all)))
  saveRDS(enlists, paste0("~/integration/2024_06/DEG/inter_lesion/enrich_cna_aff", i))
  genelists <- lapply(cna_free, generate_genelist)
  enlists <- lapply(genelists, function(x) try(GSEA(geneList = x, TERM2GENE = all)))
  saveRDS(enlists, paste0("~/integration/2024_06/DEG/inter_lesion/enrich_cna_free", i))
  print(i)
}

# downstream -------------------------------------------------------------
# 
# enlist_interpatient <- readRDS("~/integration/2024_06/DEG/enlist_interpatient.Rds")
...
# patients <- gsub(".Rds","",list.files("~/integration/2024_06/DEG/inter_lesion", pattern = "^CA"))
...
saveRDS(enrich_list, "~/integration/2024_06/DEG/inter_lesion/enrich_list.Rds")
...
saveRDS(enrichdf, "~/integration/2024_06/DEG/inter-organ_enrichment.Rds")
