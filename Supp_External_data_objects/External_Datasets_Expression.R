" 
 ...
 Data Location: mCRPC Molecular profiling - ~/ExternalDatasets/Public_prostate_single_cell/Molecular_profiling_mCRPC/
...
agilent <- read.delim("~/ExternalDatasets/Public_prostate_single_cell/Living_tumour_laboratory/GPL14550-9757.txt",
                      skip=17)
