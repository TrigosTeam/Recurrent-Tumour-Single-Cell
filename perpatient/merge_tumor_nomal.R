...
lapply(split(paths, patients), function(pathp){
  ...
  saveRDS(test, paste0("~/integration/2024_06/perpatient/tumor_normal/",patient, "_tumor_normal_RNA_simspec_srt.Rds"))
  ...
  pdf( paste0("~/integration/2024_06/perpatient/tumor_normal/",patient, "_tumor_normal_RNA_simspec_UMAP.pdf"), width = 10, height = 5)
