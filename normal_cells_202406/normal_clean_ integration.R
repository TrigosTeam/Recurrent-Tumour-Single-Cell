...
tumor_only_meta <-  readRDS("~/regulon/new_regulon/archetype/2024_06/5_integrated_final_module_meta.Rds")
...
# recluster with RNA ------------------------------------------------------
scATOMIC_result <- readRDS("~/CASCADEpaper/paper/normal_cells_202406/scATOMIC_result.Rds")
...
normal_integratedsrt <- readRDS("~/CASCADEpaper/paper/normal_cells_202406/normal_integratedsrt.Rds")
...
saveRDS(Bcells, "~/CASCADEpaper/paper/normal_cells_202406/subtype/Bcells.Rds")
saveRDS(Tcells, "~/CASCADEpaper/paper/normal_cells_202406/subtype/Tcells.Rds")
saveRDS(Macro, "~/CASCADEpaper/paper/normal_cells_202406/subtype/Macrophage.Rds")
...
saveRDS(Epi, "~/CASCADEpaper/paper/normal_cells_202406/subtype/Epi.Rds")
saveRDS(Endo, "~/CASCADEpaper/paper/normal_cells_202406/subtype/Endo1.Rds")
saveRDS(Fibro, "~/CASCADEpaper/paper/normal_cells_202406/subtype/Fibro.Rds")
saveRDS(Neuro, "~/CASCADEpaper/paper/normal_cells_202406/subtype/Neuro.Rds")
saveRDS(Hepo, "~/CASCADEpaper/paper/normal_cells_202406/subtype/Hepo.Rds")
