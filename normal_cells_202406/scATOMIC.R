...
srt <- readRDS("~/CASCADEpaper/paper/normal_cells_202406/normal_cluster_srt.Rds")

sparse_matrix <- srt@assays$RNA@counts
cell_predictions <- run_scATOMIC(sparse_matrix)
saveRDS(cell_predictions, "~/CASCADEpaper/paper/normal_cells_202406/scATOMIC_cellpred.Rds")
...
saveRDS(results_cell, "~/CASCADEpaper/paper/normal_cells_202406/scATOMIC_result.Rds")