...
paths <- system("realpath ~/Sequencing_updated_reference/CA*/*/purple/circos/*link.circos", intern = T)
...
saveRDS(sv_list2, "~/Fig3_genomics_normal_cells/structure_variants/sv_list.Rds")
