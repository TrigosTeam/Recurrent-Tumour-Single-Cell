...
SO_tablelist <- readRDS("~/Fig3_genomics_normal_cells/point_mutation/point_mutation_table_intersection.Rds")
...
# saveRDS(wgd, "wgd.Rds")
wgd <- readRDS("~/Fig3_genomics_normal_cells/wgd.Rds")
#' 
...
pdf("~/Fig3_genomics_normal_cells/oncoplot_allCASCADE.pdf", width = 13, height = 11)
