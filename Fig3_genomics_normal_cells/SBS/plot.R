library(patchwork)
setwd("~/Fig3_genomics_normal_cells/SBS")
...
png(paste0("~/Fig3_genomics_normal_cells/SBS/png/sbs.png"), height = 700, width = 500)
p
dev.off()
saveRDS(p, "~/Fig3_genomics_normal_cells/SBS/plot_obj/sbs.Rds")